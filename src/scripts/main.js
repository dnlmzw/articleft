  ...
  articleft = {
    ...
    init: function() {
      ...
      return jQuery(document).ready(function($) {
        var displayer, divCss, mainContainer, max, mins, num, scrolltop, spanCss, textElements, topParagraphNumber, wordsLeft, _i, _ref;
        max = 0;
        mainContainer = null;
        ...
        return displayer.delay(1000).fadeOut(350, function() {
